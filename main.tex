...
%     \label{fig:X}
% \end{multiFigure}
% * Make sure that there is NO NEWLINE between \begin{multiFigure} and the line ABOVE it (otherwise your figs will be off-center)!
...
% \input{tex/05_higgs_mass/obj_and_event_sel.tex}               % Fill out subsections.
