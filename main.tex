...
% \setReferenceFile{referenceFile}{amsplain}%         References. First argument is your bibtex source file (.bib) the second argument is your bibtex style file (.bst).
\setReferenceFile{referenceFile}{jhep}
...
% \setReferenceFile{newboi}{unsrtnat}
% \setReferenceFile{referenceFile}{ieeetr}
...
%=== Bibliography is printed in the command \setReferenceFile above. ===%
