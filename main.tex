...
\title{
    ...
    and Search for Di-Lepton Mass Resonances in ${\rm H \rightarrow 4\ell}$ Decays
...
%--- CMS ---%
%%%%%%%%%%%%%
% \input{tex/cms/tracker.tex}
% \input{tex/04_cms/calorimeters.tex}
% \input{tex/cms/solenoid.tex}
% \input{tex/cms/muon_system.tex}
% \input{tex/cms/trigger.tex}
% \input{tex/cms/event_reco.tex}
% \input{tex/cms/event_sim.tex}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%--- Higgs Mass Measurement ---%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% \input{tex/higgs_mass/higgs_intro.tex}
% \input{tex/higgs_mass/datasets.tex}
% \input{tex/higgs_mass/event_selection.tex}
% \input{tex/higgs_mass/observables.tex}
% \input{tex/higgs_mass/syst_uncert.tex}
% \input{tex/higgs_mass/z1_constraint.tex}
% \input{tex/higgs_mass/beamspot_constraint.tex}
% \input{tex/higgs_mass/mass_measurement.tex}
