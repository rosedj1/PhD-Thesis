...
% \input{tex/abstractFile.tex}  % Don't use this; use \setAbstractFile above.
...
%=== Main Text ===%
\begin{document}
%--- Structure of each chapter: tex/chapter/section.tex ---%
%%%%%%%%%%%%%%%
%--- Intro ---%
%%%%%%%%%%%%%%%
\input{tex/01_intro/intro.tex} % THIS
%%%%%%%%%%%%%%%%%%%%%%%%
%--- Standard Model ---%
%%%%%%%%%%%%%%%%%%%%%%%%
...
%--- LHC ---%
%%%%%%%%%%%%%
\input{tex/03_lhc/lhc.tex} % THIS
%%%%%%%%%%%%%
%--- CMS ---%
%%%%%%%%%%%%%
\input{tex/04_cms/cms_intro.tex} % THIS
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{tex/05_higgs_mass/higgs_intro.tex} % THIS
