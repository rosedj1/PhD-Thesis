...
\begin{multiFigure}
    ...
    \captionof{figure}
        ...
        {The accelerator complex at CERN. Diagram taken from~\cite{PhysRevLett.114.191803}.% TODO: correct the ref
        }
...
\begin{multiFigure}
    ...
    \captionof{figure}
        ...
        Plot taken from~\cite{PhysRevLett.114.191803}. % TODO: Point to correct citation!
        } 
    \label{plt:pileup}
\end{multiFigure}
%%%%%%%%%%%%%%%%%%%%
...
% TODO: uncomment: and to the frequency of revolution, and it is inversely proportional to the beam widths.
