...
Sandwiched between the scenic Jura mountains to the northwest and the sprawling city of Geneva (French: Genève) to the southeast is CERN. % (Fig.~\ref{fig:lhc_on_map_and_complex}, Left).
...
Protons get injected into a series of increasingly larger accelerators.
...
\begin{itemize}
    ...
    \item The penultimate step is for the SPS to further energize the protons to a center-of-mass energy of 450\GeV. % a accelerates protons to com energy
