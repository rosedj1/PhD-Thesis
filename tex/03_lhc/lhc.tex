...
\begin{itemize}
    ...
    \item Next, the SPS energizes the protons to a center-of-mass energy of 450\GeV and sends bunches of protons (so-called \emph{proton bunches}, $\approx$$\tentothe{11}$ protons) into the LHC. %  are packed together into a ``proton bunch''. % a accelerates protons to com energy
\end{itemize}
