...
\begin{multiFigure}
    ...
    \captionof{figure}
        ...
        Figures taken from~\cite{collaboration_cms_2008}. % TODO: Check where figs came from.
        }
    \label{fig:ecal_xs}
\end{multiFigure}
%%%%%%%%%%%%%%%%%%%%
...
% TODO: SHOW PICTURE OF EM SHOWER.
% TODO: REFERENCE EM SHOWER FIG.
...
\begin{multiFigure}
    ...
    \captionof{figure}
        ...
        Figure taken from~\cite{LUM-17-004}. % TODO: Point to correct citation!
        }
...
% TODO: Write nice lead into the solenoid.