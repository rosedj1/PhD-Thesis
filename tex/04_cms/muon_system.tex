...
\subsubsection{Numbering the CSCs}
...
Therefore, comparator logic is implemented to narrow down the precision to the order of 100~$\mum$ by using half-strip information (Fig.~\ref{fig:comparators}).
%%%%%%%%%%%%%%%%%%%%
\begin{figure}[pbth]
\centering
