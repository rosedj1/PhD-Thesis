...
\label{sec:muon_sys}
% TODO: Make sure all units are adjacent to their numbers.
...
\label{sec:csc} 
% TODO: Change all "ME-" to "ME$-$"? Same for +?
...
\begin{multiFigure}
    ...
    \captionof{figure}
        ...
        Figures taken from~\cite{PhysRevLett.114.191803}. % TODO: Point to correct citation!
        }
    \label{fig:cms_endcap}
\end{multiFigure}
%%%%%%%%%%%%%%%%%%%%
% TODO: Make sure \degrees look good everywhere.
\textit{\textbf{Design:}}
...
The gas mixture flows from one layer to the next in a zigzag manner and has a flow rate of 9 $\meter^3/\snd$. % TODO.
