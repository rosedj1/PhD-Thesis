...
In total, the pixel detector has around 6000 connections(channels)/$\cmns^2$.
...
Figure~\ref{fig:tracker_xs} shows a clearly labeled transverse illustration of the pixel and strip detectors.
...
\begin{multiFigure}
    ...
    \captionof{figure}
        ...
        {Depictions of the silicon tracker. Figures taken from~\cite{Tumasyan:2779091}. % TODO: Point to correct citation!
...
\begin{multiFigure}
    ...
    \captionof{figure}
        ...
        Figure taken from~\cite{LUM-18-002}. % TODO: Point to correct citation!
        }
