...
\label{sec:tracker}
% TODO: Change all "pile up" -> "pileup"
% TODO: Fix all numbers to have correct commas and kerns.
...
\label{sec:strip}
% TODO: Change all instances to: labeling / labelled
...
%%%%%%%%%%%%%%%%%%%%
%=== Simulated and real images of silicon tracker.
\begin{multiFigure}
    \centering
    \addFigure{0.49}{figures/cms/tracker/silicon_tracker_simulated.png}
    \addFigure{0.49}{figures/cms/tracker/silicon_tracker_real.jpg}
    \captionof{figure}
        ...
        The endcap components are also shown. Figure taken from~\cite{PhysRevLett.114.191803}. % TODO: Point to correct citation!
        \;B) The real silicon tracker at the center of CMS. Figure taken from~\cite{PhysRevLett.114.191803}. % TODO: Point to correct citation!
        } 
