...
and $\hat{w}^k_{\ZZ}$ accounts for the differential QCD and electroweak $K$ factors defined in TODO:REF $sec:bkg_irred$. %Sec.~\ref{sec:bkg_irred}.
...
\begin{table}[ht]	
\begin{center}
	\topcaption{Expected Higgs boson mass uncertainty measured implementing the categorisation,
