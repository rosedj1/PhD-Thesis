...
Following the prescription from before, % TODO: of TODO:CITE HIG-19-001,
% ~\cite{HIG_19_001}
the \ggzzfourl background 
is reweighted by a $K$ factor to reach NNLO precision.
%\figurename~\ref{Mass_comparison_ggZZ} shows a comparison of the ggZZ background in different final 
%states, for different years, for different reconstruction.
%\begin{figure}[!htbp]
%\begin{center}
...
%		\includegraphics[width=0.35\textwidth]{../../higgsmassmeasurement/AN-19-248/Figures/Placeholder.png}
%		\includegraphics[width=0.35\textwidth]{../../higgsmassmeasurement/AN-19-248/Figures/Placeholder.png}
%\caption{ggZZ mass distribution for 2016 on top ($4\mu$ on the left 4e on the right),
%2017 in the middle (4$\mu$ on the left 2e2$\mu$ on the right),
%2018 on bottom (4e on the left 2$\mu$2e on the right),
%Four different approaches are shown: baseline (black), refit+baseline (red), VXBS (green)
%and VXBS+refit (blue).}
%\label{Mass_comparison_ggZZ}
%\end{center}
%\end{figure}
...
For more details and plots, see below. % TODO:CITE HIG-19-001.
% ~\cite{HIG_19_001}.
%\figurename~\ref{Mass_comparison_qqZZ} shows a comparison of the qqZZ background in different final 
%states, for different years, for different reconstruction.
%\begin{figure}[!htbp]
%\begin{center}
%		\includegraphics[width=0.35\textwidth]{../../higgsmassmeasurement/AN-19-248/Figures/Placeholder.png}
...
% TODO: Get 2017 and 2016 plots?
% TODO: Change to multiFigure.
\begin{figure}[!htbp]
	\begin{center}
		\includegraphics[width=0.48\textwidth]{../../higgsmassmeasurement/AN-19-248/Figures/RedBkg/ZX_2018_4mu.pdf}
		\includegraphics[width=0.48\textwidth]{../../higgsmassmeasurement/AN-19-248/Figures/RedBkg/ZX_2018_4e.pdf}
		\includegraphics[width=0.48\textwidth]{../../higgsmassmeasurement/AN-19-248/Figures/RedBkg/ZX_2018_2e2mu.pdf}
		\includegraphics[width=0.48\textwidth]{../../higgsmassmeasurement/AN-19-248/Figures/RedBkg/ZX_2018_2mu2e.pdf}
...
\begin{center}
	\topcaption
		[Expected Higgs boson mass uncertainty measured implementing the categorisation,
