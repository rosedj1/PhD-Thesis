...
Simulated samples are reweighted by taking the pileup distribution into account.
...
Pileup distributions are shown in \cref{fig:pileupReweight} for each year.
\clearpage  % TODO: PLOTS OVERFLOW.
\begin{multiFigure}
    \centering
        \addFigure{0.5}{figures/higgsmassmeas/Reweighted_2016.png}
        \addFigure{0.5}{figures/higgsmassmeas/Reweighted_2017.png}
        \addFigure{0.5}{figures/higgsmassmeas/Reweighted_2018.png}
    \captionof{figure}
        [Data--simulation pileup distributions showing up and down scales]
        {Data--simulation pileup distributions showing up (down) scales, obtained using 72.4 (66)\mb. % TODO:REWORD 
