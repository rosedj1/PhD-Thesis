...
This chapter details the steps taken to measure \mH using full Run 2 data from the LHC collected by the CMS detector.
Although many previous measurements of \mH have already been made (\eg by the ATLAS and CMS collaborations as shown in Fig.~\ref{fig:atlas_cms_mH_meas}), the recipe for the measurement presented in this dissertation is predicted to give world's most precise value of \mH.
...
The chapter concludes with the expected \mH measurement in Sec.~\ref{sec:results} once the data are unblinded.
