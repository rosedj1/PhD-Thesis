...
\begin{multiFigure}
    ...
    \captionof{figure}
        % TODO: May need to implement A--I.
        [Scatterplots of the relative \pt error \vs $\eta$]
        {Scatterplots of the relative \pt error \vs $\eta$ for muons (left column), ECAL driven electrons (middle column), and tracker driven electrons (right column) for 2016 (top row), 2017 (middle row), and 2018 (bottom row) data.}
...
\begin{multiFigure}
    ...
    \captionof{table}
    [Lambda values.] % TODO:
    {Lambda values.} % TODO: ELIMINATE DATA FROM TABLE Convert to proper table.
