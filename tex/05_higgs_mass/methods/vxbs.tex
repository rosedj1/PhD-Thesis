...
\end{center}
\end{figure}
% TODO: Include BS vs. lumi?
%=== Beamspot width as a function of lumi section. 
% \begin{figure}[!htbp]
% \begin{center}
% 	\includegraphics[width=0.45\textwidth]{Figures/VXBS/2018_BS_width_x.pdf}
% 	\includegraphics[width=0.45\textwidth]{Figures/VXBS/2018_BS_width_y.pdf}
% 	\includegraphics[width=0.45\textwidth]{Figures/VXBS/2016_BS_width_x.pdf}
% 	\includegraphics[width=0.45\textwidth]{Figures/VXBS/2016_BS_width_y.pdf}
% 	\caption{X (left) and Y (right) width of the beamspot as a function of lumi section for 
% 	2018 RunD (top) and 2016 RunG (bottom).}
% \label{fig:BeamXY_vs_Lumi}
% \end{center}
% \end{figure}
...
and 2016 (bottom, split in post- and pre-VFP), with (red) and without (black) VXBS constraint.} % TODO: Use actual PDFs. 
...
More on beamspot constraint studies can be found in Appendix~\ref{app:adhoc_studies}. % TODO:Link not showing up

				%In this mass window, as can be seen in \figurename~\ref{pT_res_VXBS} the muon \pT resolution 
				%improves by about 5-10\%; simular improvement has been observed in the \textbf{UL samples used}
				%Z boson resolution, in both DATA and MC (\figurename~\ref{Zboson_baseline} vs 
				%~\figurename~\ref{Zboson_VXBS})
				%\begin{figure}[!htbp]
				%\begin{center}
				%		\includegraphics[width=0.35\textwidth]{Figures/VXBS/Zboson/pT_res_2016pre.pdf}
				%		\includegraphics[width=0.35\textwidth]{Figures/VXBS/Zboson/pT_res_2016post.pdf}
				%		\includegraphics[width=0.35\textwidth]{Figures/VXBS/Zboson/pT_res_2017.pdf}
				%		\includegraphics[width=0.35\textwidth]{Figures/VXBS/Zboson/pT_res_2018.pdf}
				%\caption{muon \pT resolution for 2016-preVBF (on the top left), 
				%2016-postVBF (on the top right), 
				%2017 (on the bottom left), 
				%2018 (on the bottom right), 
				%The bottom panel shows the improvement compared with 
				...
				%\begin{figure}[!htbp]
				%\begin{center}
				%		\includegraphics[width=0.35\textwidth]{Figures/VXBS/Zboson/BaselineMass_2016pre.pdf}
				%		\includegraphics[width=0.35\textwidth]{Figures/VXBS/Zboson/BaselineMass_2016post.pdf}
				%		\includegraphics[width=0.35\textwidth]{Figures/VXBS/Zboson/BaselineMass_2017.pdf} 
				%		\includegraphics[width=0.35\textwidth]{Figures/VXBS/Zboson/BaselineMass_2018.pdf} 
				%\caption{Dimuon mass distribution using baseline reconstruction, 
				%2016-preVBF (on the top left), 
				%2016-postVBF (on the top right), 
				%2017 (on the bottom left), 
				%2018 (on the bottom right), 
				%Black dots are DATA, red histogram is MC. Ratio plot is shown in the bottom panel.}
				%\label{Zboson_baseline}
				%\end{center}
				%\end{figure}
				%\begin{figure}[!htbp]
				%\begin{center}
				%		\includegraphics[width=0.35\textwidth]{Figures/VXBS/Zboson/VXBSMass_2016pre.pdf}
				%		\includegraphics[width=0.35\textwidth]{Figures/VXBS/Zboson/VXBSMass_2016post.pdf}
				%		\includegraphics[width=0.35\textwidth]{Figures/VXBS/Zboson/VXBSMass_2017.pdf} 
				%		\includegraphics[width=0.35\textwidth]{Figures/VXBS/Zboson/VXBSMass_2018.pdf} 
				%\caption{Dimuon mass distribution using VXBS reconstruction, 
				%2016-preVBF (on the top left), 
				%2016-postVBF (on the top right), 
				%2017 (on the bottom left), 
				%2018 (on the bottom right), 
...
\begin{multiFigure}[!htbp]
    \centering
        ...
        \captionof{figure}
            ...
            \;A) 4$\mu$.    % TODO: Convert to multiFigure:
            \;B) 4e.
            \;B) 2e2$\mu$.
            \;B) 2$\mu$2e.
            }
