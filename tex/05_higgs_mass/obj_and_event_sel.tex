...
% % \label{sec:fsr}
The object selection used in this analysis is summarized in Table~\ref{table:obj_sel_higgs} and the step-by-step event selection can be found in~\cite{PhysRevLett.114.191803}. % TODO:Ref HIG-19-001 EPJC.
