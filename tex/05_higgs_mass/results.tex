...
%%		\includegraphics[width=0.35\textwidth]{../../higgsmassmeasurement/AN-19-248/Figures/Placeholder.png}
%%		\caption{1D likelihood scan as a function of mass for the different fit scenaria 
%%		for the combination of all final states. Solid lines represents the scan with full 
%%		uncertainties included, dashedlines statistical error only.  
%%		Results with $Z_{1}$ mass constraint are shown on the left and without on the right.}
%%		\label{3D_refit}
%%	\end{center}
%%\end{figure}
%
...
\begin{figure}[!htbp]
\begin{center}
	\includegraphics[width=0.35\textwidth]{../../higgsmassmeasurement/AN-19-248/Figures/Impact/MassScanSyst_FullRun2.pdf}
	\includegraphics[width=0.35\textwidth]{../../higgsmassmeasurement/AN-19-248/Figures/Impact/MassScanSyst_FullRun2_FS.pdf}
	\includegraphics[width=0.35\textwidth]{../../higgsmassmeasurement/AN-19-248/Figures/Impact/MassScanSyst_FullRun2_year.pdf}
...
\begin{figure}[!htbp]
\begin{center}
	\includegraphics[width=0.55\textwidth]{../../higgsmassmeasurement/AN-19-248/Figures/Impact/impacts_V2.pdf}
	\includegraphics[width=0.45\textwidth]{../../higgsmassmeasurement/AN-19-248/Figures/Impact/impacts_V3_UL2018.pdf}
	\includegraphics[width=0.45\textwidth]{../../higgsmassmeasurement/AN-19-248/Figures/Impact/impacts_V3_UL2017.pdf}
	\includegraphics[width=0.45\textwidth]{../../higgsmassmeasurement/AN-19-248/Figures/Impact/impacts_V3_UL20165.pdf}
	\includegraphics[width=0.45\textwidth]{../../higgsmassmeasurement/AN-19-248/Figures/Impact/impacts_V3_UL20160.pdf}
...
\begin{table}[ht]	
\begin{center}
    \topcaption{Expected Higgs boson mass measurement uncertainty, given in \MeVns, for four different final 
    states only for 2016, looking at the impact of each improvement on top of the background effect.
    {\color{red}{Obtained scaling to full 2016 luminosity, 2016 post-VFP samples} }
    }
    \begin{tabular}{ccccccc}
    \hline			
    Expected uncertainty	&	4$\mu$	&	4e	&	2e2$\mu$	&2$\mu$2e	& inclusive & Rel. Improvement \\
...
%The comparison of the newest results and the previous ones from CMS \cite{HIG_16_041} is shown in 
%~\tablename~\ref{table:CMS_old_vs_new}.
%
%\begin{table}[ht]	
%\begin{center}
%\begin{tabular}{|c|c|c|}
...
%	\hline			
%	final results	&	-0.257/+0.255	 \textbf{0.104} \\
%	\hline			
%	3D model + refit (3D')	&	-0.257/+0.255	&	-0.128/+0.127 \\
%	\hline			
%\end{tabular}
%\end{center}
%\caption{ Best fit values for the mass of the Higgs boson measured in the $4\ell$ final states, 
%		with 3D model, with (top row) and without (bottom row) $Z_{1}$ constraint. 
%		All mass values are given in \GeV. The uncertainties are the total statistical 
%		plus systematic uncertainty.}
%\label{table:CMS_old_vs_new}
%\end{table}
