...
% TODO: Include ttZ and triboson info? Check EPJC.

% TODO: Go to AN-18-194v14, p. 87 for tables and such.
% TODO:UPDATE WITH DILEP TRIGGERS
...
\begin{table}[h]
    ...
    % \centering
    \topcaption
        [Trigger paths used to collect 2016 data (pre- and post-VFP)] % TODO:
        {Trigger paths used to collect 2016 data (pre- and post-VFP) for the measurement of \mh.} % TODO:
		\begin{tabular}{|lll|}
		\hline      
...
\begin{table}[h]
    ...
    % \centering
    \topcaption
        [Trigger paths used to collect 2017 data] % TODO:
        {Trigger paths used to collect 2017 data for the measurement of \mh.} % TODO:
		\begin{tabular}{|lll|}
		\hline      
        HLT path                                                        & Prescale          & Primary data set \\
        \hline
...
\begin{table}[h]
    ...
    % \centering
    \topcaption
        [Trigger paths used to collect 2018 data] % TODO:
        {Trigger paths used to collect 2018 data for the measurement of \mh.} % TODO:
		\begin{tabular}{|lcl|}
		\hline      
        HLT path                                                        & Prescale          & Primary data set \\
        \hline
...
\begin{table}[h]
    ...
    \topcaption
        ...
        \hline
        % TODO: Update Lints.
        /DoubleEG/Run2016B-ver1\_HIPM\_UL2016\_MiniAODv2-v1/MINIAOD & \multirow{5}{*}{1} \\ % TODO
        ...
        \hline
        /DoubleEG/Run2016B-ver2\_HIPM\_UL2016\_MiniAODv2-v3/MINIAOD & \multirow{5}{*}{1} \\ % TODO
        ...
        \hline
        /DoubleEG/Run2016C-HIPM\_UL2016\_MiniAODv2-v1/MINIAOD & \multirow{5}{*}{1} \\ % TODO
        ...
        \hline
        /DoubleEG/Run2016D-HIPM\_UL2016\_MiniAODv2-v1/MINIAOD & \multirow{5}{*}{1} \\ % TODO
        ...
        \hline
        /DoubleEG/Run2016E-HIPM\_UL2016\_MiniAODv2-v1/MINIAOD & \multirow{5}{*}{1} \\ % TODO
        ...
        \hline
        /DoubleEG/Run2016F-HIPM\_UL2016\_MiniAODv2-v1/MINIAOD & \multirow{5}{*}{1} \\ % TODO
        ...
        \hline
        /DoubleEG/Run2016F-UL2016\_MiniAODv2-v1/MINIAOD & \multirow{5}{*}{1} \\ % TODO
        ...
        \hline
        /DoubleEG/Run2016G-UL2016\_MiniAODv2-v1/MINIAOD & \multirow{5}{*}{1} \\ % TODO
        ...
        \hline
        /DoubleEG/Run2016H-UL2016\_MiniAODv2-v1/MINIAOD & \multirow{5}{*}{1} \\ % TODO
...
\begin{table}[h]
    ...
    \topcaption
        ...
        \hline
        % TODO: Update Lints.
        /SingleMuon/Run2017B-UL2017\_MiniAODv2-v1/MINIAOD & \multirow{5}{*}{1} \\ % TODO
        ...
        \hline
        /SingleMuon/Run2017C-UL2017\_MiniAODv2-v1/MINIAOD & \multirow{5}{*}{1} \\ % TODO
        ...
        \hline
        /SingleElectron/Run2017D-UL2017\_MiniAODv2-v1/MINIAOD & \multirow{5}{*}{1} \\ % TODO
        ...
        \hline
        /SingleElectron/Run2017E-UL2017\_MiniAODv2-v1/MINIAOD & \multirow{5}{*}{1} \\ % TODO
        ...
        \hline
        /SingleElectron/Run2017F-UL2017\_MiniAODv2-v1/MINIAOD & \multirow{5}{*}{1} \\ % TODO
...
\begin{table}[h]
    ...
    {Names of the UL 2018 data sets and the corresponding integrated luminosities $\left( \lumiint \right)$.} % TODO:
        ...
        \hline
        % TODO: Update Lints.
		/SingleMuon/Run2018A-UL2018\_MiniAODv2-v3/MINIAOD & \multirow{4}{*}{1} \\ % TODO
		...
		\hline
		/SingleMuon/Run2018B-UL2018\_MiniAODv2-v2/MINIAOD & \multirow{4}{*}{1} \\ % TODO
		...
		\hline
		/SingleMuon/Run2018C-UL2018\_MiniAODv2-v2/MINIAOD & \multirow{4}{*}{1} \\ % TODO
		...
		\hline
		/SingleMuon/Run2018D-UL2018\_MiniAODv2-v3/MINIAOD & \multirow{4}{*}{1} \\ % TODO
...
The data set names containing the simulated events for signal and background processes are listed in Tables~\ref{table:dilep_2016_simSamples}--\ref{table:dilep_2018_simSamples}. % TODO:UPDATE TABLE.
\begin{table}[h]
    \small
    \captionof{table}
        [Names of simulated signal and background samples for 2016 data] % TODO: get correct info
        {Names of simulated signal and background samples for 2016 data. \\ % TODO:
...
\begin{table}[h]
    \small
    \captionof{table}
        [Names of simulated signal and background samples for 2017 data] % TODO:
        {Names of simulated signal and background samples for 2017 data. \\ % TODO:
...
\begin{table}[h]
    \small
    \captionof{table}
        [Names of simulated signal and background samples for 2018 data] % TODO:
        {Names of simulated signal and background samples for 2018 data. \\ % TODO:
