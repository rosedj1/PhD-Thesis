...
\begin{table}[h]
    ...
    % \centering
    \topcaption
        [TODO:Trigger paths used to collect 2016 data (pre- and post-VFP)]
        {TODO:Trigger paths used to collect 2016 data (pre- and post-VFP) for the measurement of \mh.}
		\begin{tabular}{|lll|}
		\hline      
...
\begin{table}[h]
    ...
    % \centering
    \topcaption
        [TODO:Trigger paths used to collect 2017 data]
        {TODO:Trigger paths used to collect 2017 data for the measurement of \mh.}
		\begin{tabular}{|lll|}
		\hline      
        HLT path                                                        & Prescale          & Primary data set \\
        \hline
...
\begin{table}[h]
    ...
    % \centering
    \topcaption
        [TODO:Trigger paths used to collect 2018 data]
        {TODO:Trigger paths used to collect 2018 data for the measurement of \mh.}
		\begin{tabular}{|lcl|}
		\hline      
        HLT path                                                        & Prescale          & Primary data set \\
        \hline
...
\begin{table}[h]
    ...
    \centering
    \topcaption
        [TODO:Data sets used for 2016 UL]
        {TODO:Names of the UL 2016 data sets and the corresponding integrated luminosities $\left( \lumiint \right)$.}
...
\begin{table}[h]
    ...
    \centering
    \topcaption
        [TODO:UL data sets used for 2017]
        {TODO:Names of the UL 2017 data sets and the corresponding integrated luminosities $\left( \lumiint \right)$.}
		\begin{tabular}{|lc|}
		\hline      
        Data set name & Integrated luminosity (\fbinv) \\
        %$\left( \fbinv \right)$ 
...
\begin{table}[h]
    ...
    \centering
    \topcaption
    [TODO:UL data sets used for 2018]
    {TODO:Names of the UL 2018 data sets and the corresponding integrated luminosities $\left( \lumiint \right)$.}
		\begin{tabular}{|lc|}
		\hline      
        Data set name & Integrated luminosity (\fbinv) \\
        %$\left( \fbinv \right)$ 
...
TODO:UPDATE TABLE. The data set names containing the simulated events for signal and background processes are listed in Tables~\ref{table:2016_simSamples}--\ref{table:2018_simSamples}.
\begin{table}[h]
    \small
    \captionof{table}
        [TODO:Names of simulated signal and background samples for 2016 data.]
        {TODO:Names of simulated signal and background samples for 2016 data. \\
...
\begin{table}[h]
    \small
    \captionof{table}
        [TODO:Names of simulated signal and background samples for 2017 data.]
        {TODO:Names of simulated signal and background samples for 2017 data. \\
...
\begin{table}[h]
    \small
    \captionof{table}
        [TODO:Names of simulated signal and background samples for 2018 data.]
        {TODO:Names of simulated signal and background samples for 2018 data. \\
