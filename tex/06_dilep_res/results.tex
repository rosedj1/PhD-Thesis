...
\begin{multiFigure}
    \centering
        \addFigure{0.52}{figures/dilep_res/yield_hzzd_mZ2_2mu.pdf}
        \addFigure{0.52}{figures/dilep_res/yield_hzzd_mZ2_2e.pdf}
    \captionof{figure}
...
\begin{multiFigure}
    \centering
        ...
        \addFigure{0.52}{figures/dilep_res/yield_hzdzd_mZ12_2e2mu.pdf}
    \captionof{figure}
